#ifndef PRJMYSTDCPPLIB_H
#define PRJMYSTDCPPLIB_H

#include "prjmystdcpplib_global.h"
#include <string>
//#include <jni.h>
#include <vector>
#include <iostream>
...
class PRJMYSTDCPPLIBSHARED_EXPORT PrjMyStdCPPLib
{

public:
    PrjMyStdCPPLib();
    PrjMyStdCPPLib(const PrjMyStdCPPLib& orig);
